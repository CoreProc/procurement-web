...
!function(e){function n(e){e.withConfig(function(e){e.setBaseUrl("https://procex.coreproc.ph/api")});this.query=function(n){return e.one("query").get(n)}}n.$inject=["Restangular"],e.module("app.services").service("SearchService",n)}(angular);
