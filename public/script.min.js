...
!function(t){function e(t){var e="utility",i=t.withConfig(function(t){t.setBaseUrl("http://localhost/procurement-web/public/api/"+e)});this.getProvince=function(t){return i.all("lookup-province").post(t)},this.getSearch=function(t){return i.one("search").get(t)}}e.$inject=["Restangular"],t.module("app.services").service("UtilityService",e)}(angular);
