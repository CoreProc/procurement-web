...
!function(e){e.module("app").run(["$rootScope","$mdSidenav",function(n,t){n.mapConfig={bounds:{northEast:{lat:25.332189,lng:136.1616331},southWest:{lat:.751745,lng:105.525891}},defaults:{scrollWheelZoom:!0},center:{lat:0,lng:0,zoom:5},markers:{center:{lat:12.640338306846802,lng:120.84960937499999,message:"0 projects in here",focus:!0,draggable:!1}},events:{map:{enable:["moveend"],logic:"emit"}}},n.$on("leafletDirectiveMap.moveend",function(e){n.mapConfig.markers.center.lat=e.targetScope.center.lat,n.mapConfig.markers.center.lng=e.targetScope.center.lng}),n.tenderStatuses=["Cancelled","In-Preparation","Closed","Shortlisted","Awarded","Failed"],n.cardTest=[];for(var a=0;99>a;a++)n.cardTest.push({name:"Hello",budget:23423432});n.openLeftMenu=function(){t("asdf").toggle()},e.element(function(){e.element(window).resize()})}])}(angular);