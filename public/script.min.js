...
!function(e){function n(e){{var n="sample";e.withConfig(function(a){a.setBaseUrl(e.configuration.baseUrl+"/"+n)})}}n.$inject=["Restangular"],e.module("app.services").service("SampleService",n)}(angular);
...
!function(l){function n(){}n.$inject=["$scope","$stateParams"],l.module("app.controllers").controller("SampleCtrl",n)}(angular);
!function(e){e.module("app",["ngMaterial","leaflet-directive","restangular","app.services","app.directives","app.controllers"])}(angular);

!function(n){n.module("app").config(["RestangularProvider",function(){}])}(angular);
!function(n){n.module("app").run(["$rootScope","$mdSidenav","leafletBoundsHelpers",function(n,o){n.bounds={northEast:{lat:20.332189,lng:125.1616331},southWest:{lat:5.751745,lng:116.525891}},n.config={scrollWheelZoom:!1},n.openLeftMenu=function(){o("asdf").toggle()}}])}(angular);