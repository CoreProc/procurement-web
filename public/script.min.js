...
!function(e){function t(e){var t="utility",n=e.withConfig(function(e){e.setBaseUrl("http://localhost/procurement-web/public/api/"+t)});this.getProvince=function(e){return n.all("lookup-province").post(e)},this.getSearch=function(e,t){return n.one("search").one(e).one(t).get()}}t.$inject=["Restangular"],e.module("app.services").service("UtilityService",t)}(angular);
!function(e){function n(e){var n="categories",i=e.withConfig(function(n){n.setBaseUrl(e.configuration.baseUrl)});this.getAll=function(){return i.one("api").one(n).get()}}n.$inject=["Restangular"],e.module("app.services").service("CategoryService",n)}(angular);
!function(e){function n(e){var n=e.withConfig(function(n){n.setBaseUrl(e.configuration.baseUrl)});this.getProvinces=function(){return n.one("data").one("provinces").get()},this.getRegions=function(){return n.one("data").one("regions").get()}}n.$inject=["Restangular"],e.module("app.services").service("MapService",n)}(angular);
...
!function(t){function e(t,e,a,o){var i=this;i.regionData={data:[],style:{}},i.provinceData={data:[],style:{}},i.mapData=i.regionData,e.getAll().then(function(t){if("ok"!=t.status)throw new Error("Error getting categories");i.categories=t.data}),o.getRegions().then(function(t){i.regionData={data:t.geometries,style:{fillColor:"blue",weight:2,opacity:.25,color:"white",dashArray:"3",fillOpacity:.25}},i.mapData=i.regionData}),o.getProvinces().then(function(t){i.provinceData={data:t.geometries,style:{fillColor:"green",weight:0,opacity:0,color:"white",dashArray:0,fillOpacity:1}}})}e.$inject=["$scope","CategoryService","UtilityService","MapService","$mdBottomSheet"],t.module("app.controllers").controller("RootCtrl",e)}(angular);
!function(e){e.module("app",["ngMaterial","leaflet-directive","restangular","app.services","app.directives","app.controllers"])}(angular);
!function(a){a.module("app").run(["$rootScope","$mdSidenav",function(e,n){e.filtersOpen=!1,e.debug=function(a){console.log(a)},e.mapConfig={bounds:{northEast:{lat:25.332189,lng:136.1616331},southWest:{lat:.751745,lng:105.525891}},defaults:{scrollWheelZoom:!0},center:{lat:0,lng:0,zoom:5},markers:{center:{lat:12.640338306846802,lng:120.84960937499999,message:"0 projects in here",focus:!0,draggable:!1}},events:{map:{enable:["moveend"],logic:"emit"}}},e.$on("leafletDirectiveMap.moveend",function(a){e.mapConfig.markers.center.lat=a.targetScope.center.lat,e.mapConfig.markers.center.lng=a.targetScope.center.lng}),e.regions=[{name:"ARMM",provinces:[{name:"Lanao del Sur"},{name:"Maguindanao"},{name:"Sulu"},{name:"Tawi-Tawi"},{name:"Basilan"}]},{name:"CAR",provinces:[{name:"Abra"},{name:"Apayao"},{name:"Benguet"},{name:"Ifugao"},{name:"Kalinga"},{name:"Mountain Province"},{name:"Metro Manila"}]},{name:"Region I",provinces:[{name:"Ilocos Norte"},{name:"Ilocos Sur"},{name:"La Union"},{name:"Pangasinan"}]},{name:"Region II",provinces:[{name:"Batanes"},{name:"Cagayan"},{name:"Isabela"},{name:"Nueva Vizcaya"},{name:"Quirino"}]},{name:"Region III",provinces:[{name:"Aurora"},{name:"Bataan"},{name:"Bulacan"},{name:"Nueva Ecija"},{name:"Pampanga"},{name:"Tarlac"},{name:"Zambales"}]},{name:"Region IV-A",provinces:[{name:"Batangas"},{name:"Cavite"},{name:"Laguna"},{name:"Quezon"},{name:"Rizal"}]},{name:"Region IV-B",provinces:[{name:"Marinduque"},{name:"Occidental Mindoro"},{name:"Oriental Mindoro"},{name:"Palawan"},{name:"Romblon"}]},{name:"Region IX",provinces:[{name:"Zamboanga del Norte"},{name:"Zamboanga del Sur"},{name:"Zamboanga Sibugay"}]},{name:"Region V",provinces:[{name:"Albay"},{name:"Camarines Norte"},{name:"Camarines Sur"},{name:"Catanduanes"},{name:"Masbate"},{name:"Sorsogon"}]},{name:"Region VI",provinces:[{name:"Aklan"},{name:"Antique"},{name:"Capiz"},{name:"Guimaras"},{name:"Iloilo"},{name:"Negros Occidental"}]},{name:"Region VII",provinces:[{name:"Bohol"},{name:"Cebu"},{name:"Negros Oriental"},{name:"Siquijor"}]},{name:"Region VIII",provinces:[{name:"Biliran"},{name:"Eastern Samar"},{name:"Leyte"},{name:"Northern Samar"},{name:"Samar"},{name:"Southern Leyte"}]},{name:"Region X",provinces:[{name:"Bukidnon"},{name:"Camiguin"},{name:"Lanao del Norte"},{name:"Misamis Occidental"},{name:"Misamis Oriental"}]},{name:"Region XI",provinces:[{name:"Compostela Valley"},{name:"Davao del Norte"},{name:"Davao del Sur"},{name:"Davao Occidental"},{name:"Davao Oriental"}]},{name:"Region XII",provinces:[{name:"Cotabato"},{name:"Sarangani"},{name:"South Cotabato"},{name:"Sultan Kudarat"}]},{name:"Region XIII",provinces:[{name:"Agusan del Norte"},{name:"Agusan del Sur"},{name:"Dinagat Islands"},{name:"Surigao del Norte"},{name:"Surigao del Sur"}]}],e.tenderStatuses=["Cancelled","In-Preparation","Closed","Shortlisted","Awarded","Failed"],e.cardTest=[];for(var m=0;99>m;m++)e.cardTest.push({name:"Hello",budget:23423432});e.openLeftMenu=function(){n("asdf").toggle()},a.element(function(){a.element(window).resize()})}])}(angular);