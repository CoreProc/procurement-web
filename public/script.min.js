...
!function(e){function r(e){{var r="search";e.withConfig(function(e){e.setBaseUrl("https://procex.coreproc.ph/api"+r)})}this.query=function(r){return e.one("query").get(r)}}r.$inject=["Restangular"],e.module("app.services").service("SearchService",r)}(angular);
