...
!function(e){e.module("app").run(["$rootScope","$mdSidenav",function(n){n.mapConfig={defaults:{scrollWheelZoom:!0},center:{lat:12.640338306846802,lng:120.84960937499999,zoom:5},markers:{center:{lat:0,lng:0,focus:!1,draggable:!1}}},n.tenderStatuses=["Cancelled","In-Preparation","Closed","Shortlisted","Awarded","Failed"],n.cardTest=[];for(var a=0;99>a;a++)n.cardTest.push({name:"Hello",budget:23423432});e.element(function(){e.element(window).resize()})}])}(angular);