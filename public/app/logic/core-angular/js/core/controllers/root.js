(function(angular) {
     ...
     * @ngInject
     */
    function RootCtrl($scope, CategoryService, UtilityService, MapService, ClassificationService, SearchService, $mdSidenav) {
        var vm = this;
    ...
    RootCtrl.$inject     = ['$scope', 'CategoryService', 'UtilityService', 'MapService', 'ClassificationService', 'SearchService', '$mdSidenav'];
